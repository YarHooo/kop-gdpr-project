...
Навчальний проєкт для предмету **КОП**. Проєкт демонструє React-сайт з GDPR cookie popup, локальною документацією, Storybook-компонентами, ліцензією та політикою приватності.

## Автор

- **YarHooo / Ярослав Горкун**
